...
/**
 * The REST representation of a restore request.
 */
public class RestoreRequest extends AbstractRestData
{
	...
	@ValidateNotBlank
	@ValidUri(schemes = { "local", "temporary", "wamctmp", "ftp" })
	@Hashcode
	public URI backupSource;
}

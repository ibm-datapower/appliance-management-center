...
import com.ibm.amc.data.validation.validators.FilenameOnAppliance;

public class FileUploadDefinition extends AbstractRestData
{
	...
	@ValidateNotBlank
	@ValidatedAs(FilenameOnAppliance.class)

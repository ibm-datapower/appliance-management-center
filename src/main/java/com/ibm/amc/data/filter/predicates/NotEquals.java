 ...
 * @author mallman
 */
public class NotEquals extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(NotEquals.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	 ...
	 */
	public NotEquals(String name, String value)
	{
		super(name, value);
	}
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' does not equal '" + value + "'. Found: '" + name + "' = '" + objectFieldValue + "'");

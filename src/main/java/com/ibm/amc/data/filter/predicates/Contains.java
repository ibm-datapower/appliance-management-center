 ...
 * @author mallman
 */
public class Contains extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(Contains.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' contains '" + value + "'. Found: '" + name + "' = '" + objectFieldValue + "'");

 ...
 * @author mallman
 */
public class StartsWith extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(StartsWith.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' starts with '" + value + "'. Found: '" + name + "' = '" + objectFieldValue + "'");

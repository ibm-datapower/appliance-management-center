 ...
 * @author mallman
 */
public class NotEndsWith extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(NotEndsWith.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	 ...
	 */
	public NotEndsWith(String name, String value)
	{
		super(name, value);
	}
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' does not end with '" + value + "'. Found: '" + name + "' = '" + objectFieldValue + "'");

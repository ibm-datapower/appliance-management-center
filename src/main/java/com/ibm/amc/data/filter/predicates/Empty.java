 ...
 * 
 * The evaluation checks if the field value is a null or 
 * is empty when accessed as a string.
 * 
 * @author mallman
 */
public class Empty extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(Empty.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	 ...
	 */
	public Empty(String name, String value)
	{
		super(name, value);
	}
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' is empty. Found: '" + name + "' = '" + objectFieldValue + "'");
		
		if (objectFieldValue == null || objectFieldValue.isEmpty())
		{
			result = true;
		}

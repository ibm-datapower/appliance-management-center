 ...
 * @author mallman
 */
public class NotStartsWith extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(NotStartsWith.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	 ...
	 */
	public NotStartsWith(String name, String value)
	{
		super(name, value);
	}
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' does not start with '" + value + "'. Found: '" + name + "' = '" + objectFieldValue + "'");
		
		if (objectFieldValue != null && !objectFieldValue.toLowerCase().startsWith(value.toLowerCase()))
		{
			result = true;
		}

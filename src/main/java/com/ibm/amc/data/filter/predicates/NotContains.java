 ...
 * @author mallman
 */
public class NotContains extends AbstractPredicate implements Predicate
{
	// @CLASS-COPYRIGHT@

	static Logger47 logger = Logger47.get(NotContains.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	 ...
	 */
	public NotContains(String name, String value)
	{
		super(name, value);
	}
	...
	public boolean evaluate(Object object)
	{
		...
		if (logger.isDebugEnabled()) logger.debug("evaluate", "Required: '" + name + "' does not contain '" + value + "'. Found: '" + name + "' = '" + objectFieldValue + "'");
		
		if (objectFieldValue != null && !objectFieldValue.toLowerCase().contains(value.toLowerCase()))
		{
			result = true;
		}

...
/**
 * A validator that accepts only valid appliance passwords. 
 */
public class AppliancePassword implements Validator 
{
	// @CLASS-COPYRIGHT@
	...
	public boolean validate(Object value, Annotation constraints) 
	{
		...
		// TODO: determine actual Datapower password rules, if any.

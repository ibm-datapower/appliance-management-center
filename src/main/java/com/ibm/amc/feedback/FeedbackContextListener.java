...
public class FeedbackContextListener implements ServletContextListener
{
	...
	static Logger47 logger = Logger47.get(FeedbackContextListener.class.getCanonicalName(), Constants.CWZBA_BUNDLE_NAME);
	...
	public void contextInitialized(ServletContextEvent sce)
	{
		...
		sce.getServletContext().setAttribute("feedbackHandler", new FeedbackHandler());
